...
/// NEAR signature data
///
/// Uses `Base64VecU8` for binary fields to enable base64 JSON encoding.
/// This eliminates type conversions at API boundaries - both TypeScript
/// and Rust use base64 strings natively.
