...
type BannerColor = (typeof BANNER_COLORS)[number]["color"]

export function BetaBanner() {
  const [selectedColor, setSelectedColor] = useState<BannerColor>(BANNER_COLORS[1].color) // Default to Amber (recommended)
