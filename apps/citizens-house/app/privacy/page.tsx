  ...
  return (
    <article className="flex flex-col gap-[32px] items-start w-full">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            NEAR Citizen House (&ldquo;Company&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo; or &ldquo;we&rdquo;) respects your privacy and is committed to providing you with information about our and our service providers&apos; data handling practices through this privacy policy. NEAR Citizen House operates a governance participation and identity verification platform designed to enable verified participation in governance processes within the NEAR ecosystem.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            This privacy policy describes the types of information we and our Services Providers may collect from you or that you may provide when you visit our website https://citizenshouse.org/ (the &ldquo;Website&rdquo;), when you use any mobile applications to which this policy is posted (collectively, the &ldquo;Apps&rdquo; and each, an &ldquo;App&rdquo;), as well as any tools, code or other software made available for download on the Website or the Apps (collectively, the &ldquo;Tools&rdquo;). For clarity, &ldquo;Apps&rdquo; and &ldquo;Tools&rdquo; refer only to applications and tools, if any, that are operated by NEAR Citizen House and that link to or reference this Privacy Policy.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            This privacy policy is part of the Terms of Use applicable to the use of the Website and any related applications or tools operated by NEAR Citizen House. Please review this policy together with the Terms of Use, to understand all of your rights and obligations, and how we operate the Website, the Apps and the Tools.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              Through visiting or using the Website and any related applications or tools operated by NEAR Citizen House;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            ...
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              Any third party not operated or controlled by NEAR Citizen House, including third-party websites, applications, or services, even if linked from the Website.
            </li>
          </ul>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            We and our service providers may collect several types of information from and about users of the Website, the Apps and the Tools (some of which is considered &ldquo;personal information&rdquo; pursuant to applicable law), including:
          </p>
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            ...
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              Your IP address, International Mobile Equipment Identity (&ldquo;IMEI&rdquo;), or another unique identifier;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            NEAR Citizen House does not collect or store copies of passports, raw biometric identifiers, or passport chip data. Identity verification is performed by a third-party provider as described below.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            NEAR Citizen House uses a third-party identity verification provider to enable users to prove that they are a unique human being for governance participation.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            Identity verification may involve scanning a passport or other biometric identity document using a third-party mobile application. This process generates a cryptographic or zero-knowledge proof confirming identity attributes without revealing or storing the underlying document.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            NEAR Citizen House does not receive, store, or process raw biometric data or passport images. Users are subject to the privacy policy of the third-party identity verification provider when completing identity verification.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          ...
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Cookies (or browser cookies).</strong> Cookies are small text files stored through a browser on a computing or mobile device. Cookies help you navigate website pages efficiently and may improve your user experience. Note that while you can set your browser to not allow cookies, we and our service providers may not be able to honor that request, and may track your activity and collect information about you and your online activities even when the browser is set to &ldquo;do not track&rdquo;;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Web Beacons, Pixels and Tags.</strong> Pages of the Website, the Apps and the Tools, and our and our service providers&apos; e-mails, may contain small electronic files known as web beacons (also referred to as clear gifs, pixel tags, and single-pixel gifs) that permit us and our service providers, for example, to count users who have visited those pages or opened an email and for other related website statistics (for example, recording the popularity of certain content and verifying system and server integrity);
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Embedded Scripts.</strong> An embedded script is programming code that is designed to collect information about your interactions with the Website, the Apps and the Tools, such as information about the links you click on;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>ETag, or entity tag.</strong> An ETag, or entity tag, is a feature of the cache in browsers. It is an opaque identifier assigned by a web server to a specific version of a resource found at a URL. It is one of several mechanisms that HTTP provides for web cache validation. These allow websites to be more efficient and not serve content again, when data is already cached and ready to view; and
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Log Files.</strong> These track actions occurring on the Website, the Apps and the Tools, which help us and our service providers collect your IP address, browser type, Internet service provider, the webpages from which you came or to which you go before and after visiting the Website, the Apps and the Tools, and the date and time of your visits.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            Some content or applications on the Website, the Apps and the Tools may be served by third parties, including content delivery providers, analytics providers, and application service providers. These third parties may use cookies or similar tracking technologies to collect information about your use of the Website, the Apps and the Tools in accordance with their own privacy policies.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            We and our service providers do not control these third parties&apos; tracking technologies or how they may be used.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          ...
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            ...
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              For other purposes that are compatible with the purposes described in this Privacy Policy, or with your consent;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            We retain personal information only for as long as reasonably necessary to fulfill the purposes described in this Privacy Policy, including to operate the Website, maintain security, prevent fraud, comply with legal obligations, and resolve disputes. When we no longer need personal information, we will delete or de-identify it in accordance with applicable law and our retention practices.
          </p>
        </div>
      </section>
  ...
  return (
    <article className="flex flex-col gap-[32px] items-start w-full">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            This European Union and United Kingdom Privacy Addendum (&ldquo;EU/UK Addendum&rdquo;) to this Privacy Policy applies only to individuals who access or use the NEAR Citizen House website, applications, or related tools (collectively, the &ldquo;Services&rdquo;) from the European Economic Area (&ldquo;EEA&rdquo;), Switzerland, or the United Kingdom.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            This EU/UK Addendum supplements the NEAR Citizen House Privacy Policy and applies solely to the processing of personal data subject to the EU General Data Protection Regulation (&ldquo;GDPR&rdquo;) and the UK GDPR. In the event of a conflict, this Addendum controls for EU/UK users.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            For purposes of the GDPR and UK GDPR, NEAR Citizen House is the data controller with respect to personal data processed through the Services.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            As described in the main Privacy Policy, NEAR Citizen House processes limited categories of personal data, which may include:
          </p>
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            <strong>Important clarification:</strong> NEAR Citizen House does not collect or store copies of passports, raw biometric identifiers, biometric templates, or passport chip data. Identity verification is performed by a third-party provider, and NEAR Citizen House receives only confirmation or cryptographic proof of verification status.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            Personal data is collected directly from you when you interact with the Services, and automatically through your use of the Services. Limited verification-related information may also be received from third-party identity verification providers in the form of confirmation or cryptographic proof.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            We process personal data only where permitted under applicable data protection law. Our lawful bases include:
          </p>
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Performance of a contract</strong> &ndash; where processing is necessary to provide access to the Services you request;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Legitimate interests</strong> &ndash; including maintaining platform security, preventing fraud, ensuring governance integrity, and improving the reliability of the Services, where such interests are not overridden by your rights;
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              <strong>Legal obligations</strong> &ndash; where processing is required to comply with applicable laws or regulatory requirements; and
            </li>
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            Personal data is processed for purposes consistent with those described in the main Privacy Policy, including:
          </p>
          <ul className="list-disc pl-6 flex flex-col gap-[8px]">
            <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            NEAR Citizen House does not engage in automated decision-making or profiling that produces legal or similarly significant effects on individuals within the meaning of Article 22 of the GDPR.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            Your personal data may be transferred to and processed in countries outside the EEA or the UK. Where such transfers occur, we implement appropriate safeguards to ensure an adequate level of protection in accordance with applicable data protection laws, such as reliance on adequacy decisions or standard contractual safeguards.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            We retain personal data only for as long as reasonably necessary to fulfill the purposes described in the Privacy Policy and this Addendum, including for security, fraud prevention, compliance with legal obligations, and dispute resolution.
          </p>
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            If you are located in the EU or the UK, you have the right to lodge a complaint with your local data protection supervisory authority if you believe that our processing of your personal data violates applicable law.
          </p>
        </div>
      </section>
