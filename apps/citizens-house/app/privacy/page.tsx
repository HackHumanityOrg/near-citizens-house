  ...
  return (
    <article className="flex flex-col gap-[32px] items-start w-full">
      ...
      <section className="flex flex-col gap-[16px] w-full">
        ...
        <div className="flex flex-col gap-[16px] opacity-[0.88]">
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            The Website, the Apps and the Tools are not intended for children under eighteen (18) years of age. No one
            under age eighteen (18) may provide any personal information to us or our service providers or on or through
            the Website, the Apps and the Tools. We and our service providers do not knowingly or intentionally collect
            personal information from children under the age of eighteen (18). If you are under eighteen (18), do not
          ...
          <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
            ...
            eighteen (18) years of age, we will delete that information. If you believe we or our service providers
            might have any information from or about a child under the age of eighteen (18), please report this
