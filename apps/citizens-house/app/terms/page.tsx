      ...
      <section className="flex justify-center w-full px-6 md:px-0 py-[40px]">
        <article className="flex flex-col gap-[32px] items-start w-full max-w-[1055px]">
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                ...
                confirm that you have read, understood, and agree to be bound by these Terms and by our Privacy Policy,
                which is incorporated by reference. If you do not agree, you must not access or use the Services.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                If you do not meet the eligibility requirements in Section 2, you are expressly prohibited from using
                the Services.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                <strong>IMPORTANT NOTICE REGARDING DISPUTE RESOLUTION:</strong> These Terms contain a binding
                arbitration provision and a waiver of class actions and jury trials. By using the Services, you agree
                that disputes will be resolved on an individual basis through arbitration, as described in Section 15.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  &ldquo;Verification Provider&rdquo; means any independent third-party service used to perform identity
                  or uniqueness verification.
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  &ldquo;Verification Status&rdquo; means a determination, confirmation, or proof generated by a
                  Verification Provider indicating whether a user has satisfied applicable verification requirements at
                  a given time.
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  &ldquo;NEAR Ecosystem&rdquo; means the NEAR Protocol, its governance bodies, smart contracts, and
                  related community or protocol-level processes.
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  Enable users to verify that they are unique human participants through third-party identity
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Governance rules, eligibility criteria, and participation mechanisms are defined by the NEAR ecosystem
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Access to the Services may be modified or discontinued in response to governance decisions, legal
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                ...
                protocol rules, disputes, technical issues, or third-party actions.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You must use a self-custodied, NEAR-compatible wallet to interact with the Services. You are solely
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You acknowledge and accept the risks inherent in blockchain technology, including transaction
                irreversibility, network congestion, software errors, and third-party wallet vulnerabilities.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You may use the Services solely for lawful governance participation, verification, and informational
                purposes.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You must not:
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  Attempt to interfere with, disrupt, overload, or compromise the Services, including through hacking,
                  denial-of-service attacks, sybil attacks, or similar activities;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You are granted a personal, revocable, non-exclusive, non-transferable, and non-sublicensable license to
                access and use the Services solely in accordance with these Terms and solely for their intended
                purposes.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You may not copy, modify, distribute, sell, lease, reverse engineer, scrape, or create derivative works
                from any portion of the Services except as expressly permitted by law.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Our collection and use of personal information are governed by our Privacy Policy and, where applicable,
                the European Union &amp; United Kingdom Privacy Addendum, which are incorporated by reference. In the
                event of any conflict, the Privacy Policy governs matters relating to personal data.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                The Services are provided for informational and administrative purposes only. Nothing on the Services
                constitutes legal, financial, investment, governance or other professional advice. You acknowledge that
                you have not relied on any representations outside these Terms in deciding to use the Services.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  identity verification failures, errors, false positives or negatives, or revocation of verification
                  status;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  acts or omissions of third-party service providers, including identity verification providers and
                  wallet providers;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  any misrepresentation, fraud, or attempt to circumvent identity verification, eligibility, or
                  jurisdictional restrictions;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  any claim that your participation in governance violated the rights of another participant or
                  applicable rules;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  your violation of sanctions, export controls, or jurisdictional restrictions applicable to the
                  Services.
                </li>
              </ul>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <ul className="list-disc pl-6 flex flex-col gap-[8px]">
                ...
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  you have engaged in fraud, misrepresentation, identity manipulation, or attempted circumvention of
                  verification, eligibility, or jurisdictional restrictions;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  your continued access could compromise the integrity, fairness, or security of governance processes;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  your verification status has expired, been revoked, or is no longer supported by a third-party
                  verification provider;
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  we are required to do so by law, regulation, court order, sanctions requirements, or governance
                  decision; or
                </li>
                <li className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                  continued operation of the Services is no longer feasible due to technical, legal, or operational
                  considerations.
                </li>
              </ul>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Suspension or termination may occur without prior notice where necessary to protect the Services,
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                These Terms are governed by and construed in accordance with the laws of the Cayman Islands, without
                regard to conflict-of-law principles.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Any dispute, claim, or controversy arising out of or relating to the Services or these Terms shall be
                finally and exclusively resolved by binding arbitration administered by the London Court of
                International Arbitration (LCIA) in accordance with its rules in effect at the time the arbitration is
                initiated. The arbitration shall be conducted before a single arbitrator, in the English language, and
                the seat of arbitration shall be London, United Kingdom.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Before initiating arbitration, the parties agree to attempt in good faith to resolve any dispute
                informally.
              </p>
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You waive any right to participate in a class action, collective action, private attorney general
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                This section survives termination of these Terms. Any claim arising out of or relating to these Terms or
                the Services must be brought within one (1) year after the claim arises, or it is permanently barred.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                Some jurisdictions do not allow certain limitations or exclusions of liability. To the extent any
                provision of these Terms is held unenforceable under applicable law, such provision shall be limited or
                severed only to the extent necessary, and the remaining provisions shall remain in full force and
                effect.
              </p>
            </div>
          </section>
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              ...
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                In the event of any conflict between these Terms and any other referenced policy, these Terms control
          ...
          <section className="flex flex-col gap-[16px] w-full">
            ...
            <div className="flex flex-col gap-[16px] opacity-[0.88]">
              <p className="text-[16px] leading-[28px] font-fk-grotesk font-normal text-[#171717] dark:text-[#e5e5e5]">
                You consent to receive all communications, notices, disclosures, and agreements electronically. Your
                acceptance of these Terms via the Services constitutes your electronic signature.
              </p>
            </div>
          </section>
