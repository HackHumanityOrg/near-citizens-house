      ...
      <div className="hidden md:flex items-end justify-end p-20">
        ...
        <div className="flex items-center gap-6">
          <a
            ...
            className="text-sm text-[#040404] dark:text-foreground hover:opacity-70 transition-opacity tracking-[0.14px]"
          >
            Built by HackHumanity
          </a>
          <span className="text-sm text-[#040404] dark:text-foreground">•</span>
          <a
          ...
          >
            <svg
              ...
              className="fill-[#1f2328] dark:fill-foreground"
            >
              <title>GitHub</title>
