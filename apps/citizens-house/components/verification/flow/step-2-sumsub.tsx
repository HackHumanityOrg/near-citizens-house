                ...
                <div className="flex flex-col gap-[16px] items-start pt-[40px] md:pt-0 w-full md:flex-1 px-[24px] md:px-0">
                  ...
                  {verificationStatus === "polling" && (
                    <div className="mt-[16px] flex items-center gap-[8px] text-[14px] text-[#757575] dark:text-[#a3a3a3]">
                      ...
                      <span className="font-fk-grotesk">Verifying&hellip; in rare cases, this can take 20–30 minutes. If it takes longer than 30 minutes, please <a href="https://t.me/nearcitizenshouse/6" target="_blank" rel="noopener noreferrer" class="underline hover:opacity-70 transition-opacity">contact us</a>.</span>
                    </div>
                  )}
                </div>
