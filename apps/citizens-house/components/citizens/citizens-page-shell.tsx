...
interface CitizensPageShellProps {
  children: ReactNode
  starIdPrefix?: string
}

export function CitizensPageShell({ children, starIdPrefix = "citizensStar" }: CitizensPageShellProps) {
  return (
    <div className="w-full">
      ...
      <section className="relative h-[480px] md:h-[560px] -mt-32 pt-32 overflow-hidden">
        ...
        >
          <StarPattern className="w-full h-full text-[#FFDA1E] dark:text-[#FFDA1E]/30" idPrefix={starIdPrefix} />
        </div>
