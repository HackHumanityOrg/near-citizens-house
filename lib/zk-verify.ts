...
export interface StoredProofData {
  proof: ZkProof
 ...
 */
export async function verifyStoredProof(storedProof: StoredProofData, attestationId: number = 1): Promise<boolean> {
